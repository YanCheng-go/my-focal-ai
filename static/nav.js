...
(function() {
    ...
    nav.innerHTML =
        '<div class="max-w-4xl mx-auto px-3 sm:px-5 py-3">' +
        '<div class="flex items-center gap-x-4 gap-y-2">' +
            ...
            '<div class="flex items-center gap-0.5 sm:gap-1 ml-auto min-w-0">' + rightSide +
