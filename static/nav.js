...
(function() {
    ...
    var rightSide =
        '<button onclick="if(typeof startTour===\'function\')startTour();else location.href=\'index.html?tour=1\'" class="p-1.5 rounded cursor-pointer text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-neutral-800" title="Take a tour" id="tour-help-btn"><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01"/></svg></button>' +
